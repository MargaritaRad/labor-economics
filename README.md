...
We provide a brief description of the individual lectures and link the their slides. All lectures are also available for download as a single file [here](https://github.com/HumanCapitalAnalysis/labor_economics/blob/master/distribution/course_deck.pdf).
...
[![Build Status](https://travis-ci.org/HumanCapitalAnalysis/economics.svg?branch=master)](https://travis-ci.org/HumanCapitalAnalysis/labor_economics)
