...
\begin{frame}
\begin{itemize}\setlength\itemsep{1em}
\item It depends on the share of low productivity individuals whether high productivity individuals actually prefer a no-signaling case. The surplus is determined as follows:
