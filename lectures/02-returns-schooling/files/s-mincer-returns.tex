...
\LARGE\textbf{Mincer rate of return}
...
\item linear and homogeneous returns to schooling
\item additive separability
\end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
\begin{align*}
V(s) = Y(s)\int_s^T e^{-rt} dt = \frac{Y(s)}{r}(e^{-rs} - e^{-rT}).\vspace{0.3cm}
\end{align*}

Note that one's working life can either be spend in school or in the labor market.
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}
...
$\Rightarrow$ $\rho_s$ equals the market interest rate and the internal rate of return to schooling by construction (as $T$ gets large)
...
\kappa & \text{decline in post-school investment with $T$}
\end{array}\end{align*}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
Note that we also assume that the return to post-school investment is constant over ages and equals $\rho_0$.
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}
...
%-------------------------------------------------------------------------------
\begin{frame}
The following results are based on the synthetic cohort approach using the United States Census.
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}[plain]
