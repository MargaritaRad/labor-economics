...
\item compensating differences model \cite{Mincer.1958}
\item accounting-identity model \cite{{Mincer.1974}}
\end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
We can derive $(1)$ using results for arithmetic series.
