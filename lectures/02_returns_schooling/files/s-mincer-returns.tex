...
\begin{align*}
\rho_0\sum_{j=1}^{x} \kappa \left(1 - j/T\right) & = \rho_0 \sum_{j=1}^{x} \kappa - \rho_0\kappa \sum_{j=1}^{x} \left(j/T\right)\\
    & = \rho_0 \kappa x - \frac{\rho_0\kappa}{T} \sum_{j=1}^{x} j\\
    & = \rho_0 \kappa x - \frac{\rho_0\kappa}{T} x\left(\frac{1+x}{2}\right) \\
    & = \rho_0 \kappa x - \frac{\rho_0\kappa}{2T} x - \frac{\rho_0\kappa}{2T} x^2  \\
