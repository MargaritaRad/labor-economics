...
\scalebox{0.35}{\includegraphics{fig-model-option-uncertainty}}
\end{figure}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
\scalebox{0.35}{\includegraphics{fig-model-option-nonlinearities}}
\end{figure}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
\begin{figure}[htp]\centering
\caption{Returns}
\scalebox{0.35}{\includegraphics{fig-model-option-returns}}
\end{figure}
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
\scalebox{0.35}{\includegraphics{fig-model-option-structure}}
\end{figure}
\end{frame}
